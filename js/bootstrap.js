...
+ function (g) {
  ...
  i.prototype.close = function (a) {
    ...
    a.isDefaultPrevented() || (d.removeClass('in'), g.support.transition && d.hasClass('fade') ? d.one('bsTransitionEnd', m).emulateTransitionEnd(i.TRANSITION_DURATION)  : m())
  };
  var h = g.fn.alert;
  g.fn.alert = f,
...
+ function (f) {
  ...
  h.prototype.toggle = function () {
    ...
    if (d.length) {
      ...
      'radio' == j.prop('type') && (j.prop('checked') && this.$element.hasClass('active') ? i = !1 : d.find('.active').removeClass('active')),
      i && j.prop('checked', !this.$element.hasClass('active')).trigger('change')
    } else {
  ...
  f(document).on('click.bs.button.data-api', '[data-toggle^="button"]', function (b) {
    ...
    f(a.target).closest('.btn').toggleClass('focus', 'focus' == a.type)
  })
}(jQuery),
+ function (g) {
  function f(a) {
    return this.each(function () {
      ...
      c = g.extend({
      }, j.DEFAULTS, l.data(), 'object' == typeof a && a),
  ...
  j.prototype.slide = function (x, w) {
    var v = this.$element.find('.item.active'),
    u = w || this.getItemForDirection(x, v),
    t = this.interval,
    s = 'next' == x ? 'left' : 'right',
    r = 'next' == x ? 'first' : 'last',
    q = this;
    ...
    if (this.$element.trigger(o), !o.isDefaultPrevented()) {
      ...
      return g.support.transition && this.$element.hasClass('slide') ? (u.addClass(x), u[0].offsetWidth, v.addClass(s), u.addClass(s), v.one('bsTransitionEnd', function () {
        u.removeClass([x,
      ...
      }).emulateTransitionEnd(j.TRANSITION_DURATION))  : (v.removeClass('active'), u.addClass('active'), this.sliding = !1, this.$element.trigger(a)),
      t && this.cycle(),
      this
    }
  };
...
+ function (g) {
  function f(a) {
    var k,
    e = a.attr('data-target') || (k = a.attr('href')) && k.replace(/.*(?=#[^\s]+$)/, '');
    return g(e)
  }
  function j(a) {
    return this.each(function () {
      ...
      b = g.extend({
      }, i.DEFAULTS, k.data(), 'object' == typeof a && a);
      !d && b.toggle && 'show' == a && (b.toggle = !1),
  ...
  var i = function (a, d) {
    ...
    this.$trigger = g(this.options.trigger).filter('[href="#' + a.id + '"], [data-target="#' + a.id + '"]'),
  ...
  i.prototype.show = function () {
    if (!this.transitioning && !this.$element.hasClass('in')) {
      var a,
      m = this.$parent && this.$parent.find('> .panel').children('.in, .collapsing');
    ...
    if (/(38|40|27|32)/.test(a.which)) {
      ...
      if (a.preventDefault(), a.stopPropagation(), !t.is('.disabled, :disabled')) {
        ...
        if (!r && 27 != a.which || r && 27 == a.which) {
          return 27 == a.which && s.find(m).trigger('focus'),
          t.trigger('click')
        }
        ...
        if (f.length) {
          ...
          38 == a.which && c > 0 && c--,
          40 == a.which && c < f.length - 1 && c++,
          ~c || (c = 0),
          f.eq(c).trigger('focus')
        }
      }
    }
  };
...
+ function (f) {
  function e(a, c) {
    return this.each(function () {
      ...
      d = i.data('bs.modal'),
      b = f.extend({
      }, h.DEFAULTS, i.data(), 'object' == typeof a && a);
  ...
  h.prototype.show = function (a) {
    ...
    this.isShown || c.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.$body.addClass('modal-open'), this.setScrollbar(), this.escape(), this.$element.on('click.dismiss.bs.modal', '[data-dismiss="modal"]', f.proxy(this.hide, this)), this.backdrop(function () {
...
+ function (f) {
  function e(a) {
    return this.each(function () {
      ...
      c = 'object' == typeof a && a,
      b = c && c.selector;
      (i || 'destroy' != a) && (b ? (i || j.data('bs.tooltip', i = {
      }), i[b] || (i[b] = new h(this, c)))  : i || j.data('bs.tooltip', i = new h(this, c)), 'string' == typeof a && i[a]())
    })
  }
  var h = function (d, c) {
  ...
  h.prototype.init = function (a, p, o) {
    ...
    this.$viewport = this.options.viewport && f(this.options.viewport.selector || this.options.viewport);
  ...
  h.prototype.leave = function (a) {
    var d = a instanceof this.constructor ? a : f(a.currentTarget).data('bs.' + this.type);
    return d || (d = new this.constructor(a.currentTarget, this.getDelegateOptions()), f(a.currentTarget).data('bs.' + this.type, d)),
  ...
  h.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (y) {
        ...
        A = 'bottom' == A && x.bottom + v > s.bottom ? 'top' : 'top' == A && x.top - v < s.top ? 'bottom' : 'right' == A && x.right + w > s.width ? 'left' : 'left' == A && x.left - w < s.left ? 'right' : A,
  ...
  h.prototype.hide = function (a) {
    ...
    c.isDefaultPrevented() ? void 0 : (i.removeClass('in'), f.support.transition && this.$tip.hasClass('fade') ? i.one('bsTransitionEnd', k).emulateTransitionEnd(h.TRANSITION_DURATION)  : k(), this.hoverState = null, this)
  },
  ...
  h.prototype.toggle = function (a) {
    var d = this;
    a && (d = f(a.currentTarget).data('bs.' + this.type), d || (d = new this.constructor(a.currentTarget, this.getDelegateOptions()), f(a.currentTarget).data('bs.' + this.type, d))),
...
+ function (f) {
  function e(a) {
    return this.each(function () {
      ...
      c = 'object' == typeof a && a,
      b = c && c.selector;
      (i || 'destroy' != a) && (b ? (i || j.data('bs.popover', i = {
      }), i[b] || (i[b] = new h(this, c)))  : i || j.data('bs.popover', i = new h(this, c)), 'string' == typeof a && i[a]())
    })
  }
  var h = function (d, c) {
...
+ function (f) {
  function e(i, b) {
    ...
    this.$body = f('body'),
    this.$scrollElement = f(f(i).is('body') ? window : i),
    this.options = f.extend({
    }, e.DEFAULTS, b),
  ...
  e.prototype.refresh = function () {
    var a = 'offset',
    j = 0;
    f.isWindow(this.$scrollElement[0]) || (a = 'position', j = this.$scrollElement.scrollTop()),
    this.offsets = [
    ],
    this.targets = [
    ],
    ...
    this.$body.find(this.selector).map(function () {
      ...
      b = /^#./.test(c) && f(c);
      return b && b.length && b.is(':visible') && [[b[a]().top + j,
      c]] || null
    }).sort(function (d, c) {
      return d[0] - c[0]
    }).each(function () {
...
+ function (g) {
  ...
  j.prototype.activate = function (a, n, m) {
    function l() {
      ...
      a.parent('.dropdown-menu') && a.closest('li.dropdown').addClass('active').end().find('[data-toggle="tab"]').attr('aria-expanded', !0),
      m && m()
    }
    var k = n.find('> .active'),
